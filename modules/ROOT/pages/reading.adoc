...
* https://bernsteinbear.com/blog/zkp/[A quick look at zero-knowledge proofs]
* https://www.benjoffe.com/fast-day-of-week[A faster way to calculate the day of the week]
