...
* https://github.com/netdata/netdata[netdata/netdata] - Architected for speed. Automated for easy. Monitoring and troubleshooting, transformed!
...
* https://github.com/organicmaps/organicmaps[organicmaps/organicmaps] - 🍃 Organic Maps is a free Android & iOS offline maps app for travelers, tourists, hikers, and cyclists. It uses crowd-sourced OpenStreetMap data and is developed with love by the community. No ads, no 
...
* https://github.com/ente-io/ente[ente-io/ente] - FOSS, End to End Encrypted alternative to Google Photos and Apple Photos
...
* https://github.com/OXY2DEV/markview.nvim[OXY2DEV/markview.nvim] - ☄️ Highly customisable markdown(latex & inline html) previewer for Neovim
...
* https://github.com/Malix-Labs/awesome_atomic[Malix-Labs/awesome_atomic] - An awesome curated knowledge-base about atomic systems
...
* https://github.com/camel-ai/camel[camel-ai/camel] - 🐫 CAMEL: Finding the Scaling Law of Agents. The first and the best multi-agent framework. https://www.camel-ai.org
...
* https://github.com/commaai/openpilot[commaai/openpilot] - openpilot is an operating system for robotics. Currently, it upgrades the driver assistance system on 275+ supported cars.
...
* https://github.com/lexiforest/curl-impersonate[lexiforest/curl-impersonate] - An active fork of curl-impersonate with more versions and build targets.
* https://github.com/ublue-os/bazzite[ublue-os/bazzite] - Bazzite is a cloud native image built upon Fedora Atomic Desktops that brings the best of Linux gaming to all of your devices - including your favorite handheld.
