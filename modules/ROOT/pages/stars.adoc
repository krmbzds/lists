...
* https://github.com/tigerbeetle/tigerbeetle[tigerbeetle/tigerbeetle] - The distributed financial accounting database designed for mission critical safety and performance.
