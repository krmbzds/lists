...
* https://github.com/TodePond/C[TodePond/C] - perfect programming language
...
* https://github.com/ludwig-ai/ludwig[ludwig-ai/ludwig] - Declarative framework for building LLMs, neural networks, and GBMs
