...
* https://github.com/emiasims/tree-sitter-org[emiasims/tree-sitter-org] - Org grammar for tree-sitter
...
* https://github.com/drduh/YubiKey-Guide[drduh/YubiKey-Guide] - Community guide to using YubiKey for GnuPG and SSH - protect secrets with hardware crypto.
...
* https://github.com/OpenCity2k/SC2k-docs[OpenCity2k/SC2k-docs] - Documentation related to the implementation of Maxis' game, SimCity 2000.
...
* https://github.com/drduh/macOS-Security-and-Privacy-Guide[drduh/macOS-Security-and-Privacy-Guide] - Community guide to securing and improving privacy on macOS.
...
* https://github.com/drduh/config[drduh/config] - Configuration files and scripts used in guides and for system setup.
...
* https://github.com/nicely/saas-simulation[nicely/saas-simulation] - Everything that you need to see what's going on for your saas business
